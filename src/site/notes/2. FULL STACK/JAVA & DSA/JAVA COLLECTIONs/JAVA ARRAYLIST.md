---
{"dg-publish":true,"permalink":"/2-full-stack/java-and-dsa/java-collectio-ns/java-arraylist/","noteIcon":""}
---

#java #java_collection_framework #Object_Oriented_Programming 
...
***
# WHEN TO USE 
1. When needed in **Ordered Form** as given. 
2. When needed **Duplicate Elements**. 
***
***
- ArrayList can be used for *changing the size* of the array **DYNAMICALLY**.
```java
// General Syntax
ArrayList<Obj_type> VarName = new ArrayList<>();
// OR
List<Obj_Type> var_name = new ArrayList<>();
...
```java
// General Syntax
obj_varName.get(index); //starts from 0
