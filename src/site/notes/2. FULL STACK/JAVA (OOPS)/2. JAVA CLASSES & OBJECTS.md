---
{"dg-publish":true,"permalink":"/2-full-stack/java-oops/2-java-classes-and-objects/","noteIcon":""}
---
...
***
![Pasted image 20250109151700.png](/img/user/_resources/Pasted%20image%2020250109151700.png)
***
# CLASS
...
> [!question]
> 1. **Can classes exist without variables?**
> *Yes*
> 2. **And without methods?**
>*Yes*, but should contain at least one method/function to get the program running. (i.e. MAIN function)
> 
```Java
...
> The **`new`**  Keyword is *dynamic memory allocation* done in **runtime**
